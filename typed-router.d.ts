...
declare module '@vue-router/routes' {
  export interface RouteNamedMap {
    ...
    'contoh': RouteRecordInfo<'contoh', '/contoh', Record<never, never>, Record<never, never>>,
    'latihan': RouteRecordInfo<'latihan', '/latihan', Record<never, never>, Record<never, never>>,
